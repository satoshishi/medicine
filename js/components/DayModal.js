...
export default {
  ...
  computed: {
    ...
    // 朝の血圧
    morningSystolic: {
      get() { return this.record?.bloodPressure?.morning?.systolic ?? ''; },
      set(val) { this.setBp('morning', 'systolic', val); },
    },
    morningDiastolic: {
      get() { return this.record?.bloodPressure?.morning?.diastolic ?? ''; },
      set(val) { this.setBp('morning', 'diastolic', val); },
    },
    morningPulse: {
      get() { return this.record?.bloodPressure?.morning?.pulse ?? ''; },
      set(val) { this.setBp('morning', 'pulse', val); },
    },

    // 夜の血圧
    eveningSystolic: {
      get() { return this.record?.bloodPressure?.evening?.systolic ?? ''; },
      set(val) { this.setBp('evening', 'systolic', val); },
    },
    eveningDiastolic: {
      get() { return this.record?.bloodPressure?.evening?.diastolic ?? ''; },
      set(val) { this.setBp('evening', 'diastolic', val); },
    },
    eveningPulse: {
      get() { return this.record?.bloodPressure?.evening?.pulse ?? ''; },
      set(val) { this.setBp('evening', 'pulse', val); },
    },
  },
  ...
  methods: {
    ...
    setBp(timeOfDay, field, val) {
      ...
      if (!this.record.bloodPressure[timeOfDay]) {
        this.record.bloodPressure[timeOfDay] = { systolic: null, diastolic: null, pulse: null };
      }
      this.record.bloodPressure[timeOfDay][field] = num;
      // そのtimeOfDayが全nullならnullに
      const slot = this.record.bloodPressure[timeOfDay];
          ...
          <div class="bp-input-grid">
            <div class="bp-input-group">
              ...
              <input
                ...
                @input="morningSystolic = $event.target.value"
              />
            ...
            <div class="bp-input-group">
              ...
              <input
                ...
                @input="morningDiastolic = $event.target.value"
              />
              <div class="bp-input-unit">mmHg</div>
            </div>
            <div class="bp-input-group">
              ...
              <input
                ...
                placeholder="---"
                :value="morningPulse"
                @input="morningPulse = $event.target.value"
              />
          ...
          <div class="bp-input-grid">
            <div class="bp-input-group">
              ...
              <input
                ...
                @input="eveningSystolic = $event.target.value"
              />
              <div class="bp-input-unit">mmHg</div>
            </div>
            <div class="bp-input-group">
              ...
              <input
                ...
                @input="eveningDiastolic = $event.target.value"
              />
              <div class="bp-input-unit">mmHg</div>
            </div>
            <div class="bp-input-group">
              ...
              <input
                ...
                placeholder="---"
                :value="eveningPulse"
                @input="eveningPulse = $event.target.value"
              />
              <div class="bp-input-unit">bpm</div>
            </div>
          </div>
